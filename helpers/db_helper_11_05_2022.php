...
if ( ! function_exists('drop_trigger'))
{
	...
	/*function test(){
		...
		//echo  __DIR__ . 'libraries/Twilio/autoload.php';die;

// Use the REST API Client to make requests to the Twilio REST API
use Twilio\Rest\Client;

		$sid    = "AC42682053e11c7df49ecdb31cdb9b53d8"; 
$token  = "534579f0818d43cbda38cbbd73895f12"; 
$twilio = new Client($sid, $token); 
 
$message = $twilio->messages 
                  ->create("+918587086125", // to 
                           array(  
                               "messagingServiceSid" => "MG0ec3c677657fc6bddfd8f5573f43a1a4",      
                               "body" => "testing via code" 
                           ) 
                  ); 
