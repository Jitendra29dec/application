...
<div id="container">
    ...
    <div id="body">
        ...
        <ol>
			...
			<li><a href="<?php echo site_url('locality/get'); ?>">GET LOCALITY</a></li>
			<li><a href="<?php echo site_url('device/add'); ?>">ADD DEVICE DETAIL</a></li>
			<li><a href="<?php echo site_url('ad/get'); ?>">GET AD</a></li>
			<li><a href="<?php echo site_url('category/get'); ?>">GET CATEGORY</a></li>
