...
<div style="background: #fff;box-shadow: 0 0 4px #d8d8d8;border-radius: 0 0 4px 4px;padding: 30px;text-align: center;min-height: 400px;">
	...
	<p style="font-size: 21px;color: #4c4c4c;margin-top: 0;">I have left for the day, please reschedule.</p>
<a href="#" style="padding: 12px 22px;display: inline-block;background: #000000;color: #fff;text-decoration: none;font-size: 20px;border-radius: 4px;margin-top: 20px;font-weight: 500;">Schedule Now</a>
</div>
<!-- content -->
</div>
</body>
