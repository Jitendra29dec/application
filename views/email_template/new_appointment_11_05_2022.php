...
<div class="header" style="margin-bottom: 14px; "> 
	<a href="#"><img src="<?php echo base_url();?>assets/img/email_image/booknpay.png" style="height: 62px; "></a>
    <span></span>
</div>
<!-- banner -->
<div style="background: #05bae1;box-shadow: 0 0 4px #d8d8d8;border-radius: 4px 4px 0 0;padding: 00;">
	<img src="<?php echo base_url();?>assets/img/email_image/reAppointment.jpg" style="height: 163px;margin: 0 auto;display: block;width: 100%;object-fit: cover;object-position: bottom;">
</div>
<!-- content -->
<div style="background: #fff;box-shadow: 0 0 4px #d8d8d8;border-radius: 0 0 4px 4px;padding: 30px;text-align: center;min-height: 400px;box-sizing: border-box;">
	<?php
		    $search  = array('{name}', '{date}','{time}','{store}','{stylist}');
			$replace = array($getData['customer_name'], $getData['appointment_date'],$getData['start_time']." ".$getData['time_format'],$getData['store_name'],$getData['stylist_name']);
