...
<div style="background: #fff;box-shadow: 0 0 4px #d8d8d8;border-radius: 0 0 4px 4px;padding: 30px;text-align: center;min-height: 400px;box-sizing: border-box;">
	<h2 style="font-size: 40px;font-weight: 400;margin-bottom: 10px;">Dear <b><?php echo $customer_name;?></b>,</h2> 
	<p style="font-size: 21px;color: #4c4c4c;margin-top: 0;margin-bottom: 40px;">We are happy to inform you that Your appointment has been accepted.</p>
