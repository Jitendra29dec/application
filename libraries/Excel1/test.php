...
// Format for the headings
  ...
  $worksheet1->write(3,0,"22222222-2");
  $worksheet1->write(3,1,"John Smith");
  $worksheet1->write(3,2,"Main Street 100");
  $worksheet1->write(3,3,"02-5551234");
  $worksheet1->write(3,4,100);

  $worksheet1->write(4,0,"11111111-1");
  $worksheet1->write(4,1,"Juan Perez");
  $worksheet1->write(4,2,"Los Paltos 200");
  $worksheet1->write(4,3,"03-5552345");
  $worksheet1->write(4,4,110);

$worksheet1->write_formula(4, 5, "=sum(4+5)");
